...
const Hero = () => {
    ...
    useGSAP(() => {
        ...
        const heroSplit = new SplitText('.title', {type: 'chars, words'}); //To animate each characters.
        const paraSplit = new SplitText('.subtitle', {type: 'lines'}); //Just to animate the line by line not words or chars.
