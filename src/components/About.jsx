...
const About = () => {
    ...
    useGSAP(() => {
        ...
        .from(titlesplit.words, {
            opacity: 0,
            duration:1, yPercent: 100, ease: 'expo.out', stagger: 0.02
        })
        ...
        .from('.top-grid div, .bottom-grid div', {
            ...
            ease: 'power1.inOut',
            stagger: 0.04,
        }, '-=0.5') // It will make the animation start before previous animation ends
            ...
            <div className="content">
                ...
                <div className="sub-content">
                    <p>
                        ...
                        drink int something truly memorable.
                    </p>
                    <div>
